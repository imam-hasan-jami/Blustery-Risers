...
const OldPlayerDetails = () => {
    ...
    const { _id, photoURL, name, position, jerseyNumber, school, age, batch, preferredFoot } = useLoaderData();
    ...
    return (
        <div>
            ...
            <div className='flex justify-center mt-5'>
                <Link to="/old-squad" className='btn btn-neutral'>Back to Old Squad</Link>
            </div>
        </div>
    );
};

export default OldPlayerDetails;